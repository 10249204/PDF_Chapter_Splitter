# PDF Chapter Splitter Development History

This document preserves the Phase 1-16 architecture notes and development history.
The main README is now focused on normal user installation and usage.
